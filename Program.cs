...
namespace Guia1_Unidad1 
{
    class Program
    {
        ...
        {
            /*BLOQUE 1 DE EJERCICIOS*/

            //CalculadoraIMC calculadoraIMC = new CalculadoraIMC();
            //ConversionTemperatura conversionTemperatura = new ConversionTemperatura();
            //DesgloseBilletes desgloseBilletes = new DesgloseBilletes();
            //CalculadoraPrestamoSimple calculadoraPrestamoSimple = new CalculadoraPrestamoSimple();
            // TiempoTranscurrido tiempoTranscurrido  = new TiempoTranscurrido();
            //AreaYPerimetro areaYPerimetro = new AreaYPerimetro();
            //ConversionUnidadesDeAlmacenamiento conversionUnidadesDeAlmacenamiento = new ConversionUnidadesDeAlmacenamiento();
            //CalculoSalarioSemanal calculoSalarioSemanal = new CalculoSalarioSemanal();


            /**BLOQUE 2 DE EJERCICIOS**/

            //ClasificacionDeTriangulos clasificacionDeTriangulos = new ClasificacionDeTriangulos();
            //SistemaCalificacionesUNAH sistemaCalificacionesUNAH = new SistemaCalificacionesUNAH();
